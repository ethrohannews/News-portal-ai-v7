  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-red-50 to-pink-50">
      ...
      {breakingNewsTicker.length > 0 && (
        <div className="bg-gradient-to-r from-red-600 to-red-700 text-white py-2 px-2 md:px-4 overflow-hidden">
          <div className="flex items-center">
            <div className="flex items-center space-x-1 md:space-x-2 bg-white/20 px-2 md:px-3 py-1 rounded-full mr-2 md:mr-4 flex-shrink-0">
              <Zap className="w-3 h-3 md:w-4 md:h-4 animate-pulse" />
              <span className="font-bold text-xs md:text-sm">ব্রেকিং নিউজ</span>
            </div>
